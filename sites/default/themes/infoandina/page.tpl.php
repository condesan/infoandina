...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page"><div id="page-inner">
   ...
   <div id="header" ><div id="header-inner" class="clear-block">
			...
			<?php print theme('links', menu_navigation_links('menu-principal'), array('id'=>'principal')); ?>
...
<div id="header_bottom"><?php  if($header_bottom) { print $header_bottom; }  ?></div>

      <?php if ($search_box || $primary_links || $secondary_links || $navbar): ?>
        <div id="navbar2"><div id="navbar-inner" class="clear-block region region-navbar">
